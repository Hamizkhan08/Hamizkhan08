...
💡 **Data Analyst** skilled in Python, SQL, and data visualization with experience transforming complex datasets into actionable insights.  
📊 Experienced in **Power BI dashboards, machine learning models, and automation workflows**.  
🤖 Currently exploring **GenAI, NLP, and AI-powered analytics systems**.
...
AI powered dermatology diagnostic device built using **ViT Transformer, CNN, Raspberry Pi and DinoV2** enabling real-time skin disease detection designed for **offline rural healthcare environments**.

### 🤖 Grievance Resolver AI
Multi-agent grievance resolution platform built with **LangGraph & LangChain** featuring **9 AI agents**, multilingual chatbot, complaint routing system, and **React + FastAPI backend**.

### 📊 Blinkit Sales & Operations Dashboard
Power BI dashboard analyzing **$1.2M sales and 8500+ transactions**, revealing outlet profitability patterns and customer purchasing trends.

### 🧠 Customer Segmentation System
RFM feature engineering + **K-Means clustering on 10,000+ retail records**, achieving **82% segmentation accuracy**.
...
<img src="https://img.shields.io/badge/GeminiAI-blue?style=flat-square"/>
...
<img src="https://img.shields.io/badge/LookerStudio-4285F4?style=flat-square"/>
...
Application No. **202621003570 A**

AI based dermatology diagnostic system integrating **adaptive illumination control, edge AI processing, and confidence-regulated CNN classification** for reliable offline medical diagnosis.
